...
export default {
  ...
  apparel: <path d="M7 0H6L0 3v6l4-1v12h12V8l4 1V3l-6-3h-1a3 3 0 0 1-6 0z" />,
  "arrow-down": (
  ...
  "arrow-thick-down": <path d="M7 10V2h6v8h5l-8 8-8-8h5z" />,
  "arrow-thick-left": <path d="M10 13h8V7h-8V2l-8 8 8 8v-5z" />,
  "arrow-thick-right": <path d="M10 7H2v6h8v5l8-8-8-8v5z" />,
  "arrow-thick-up": <path d="M7 10v8h6v-8h5l-8-8-8 8h5z" />,
  "arrow-thin-down": (
  ...
  "backward-step": <path d="M4 5h3v10H4V5zm12 0v10l-9-5 9-5z" />,
  backward: <path d="M19 5v10l-9-5 9-5zm-9 0v10l-9-5 9-5z" />,
  badge: (
  ...
  bolt: <path d="M13 8V0L8.11 5.87 3 12h4v8L17 8h-4z" />,
  "book-reference": (
  ...
  bookmark: <path d="M2 2c0-1.1.9-2 2-2h12a2 2 0 0 1 2 2v18l-8-4-8 4V2z" />,
  "border-all": (
  ...
  document: <path d="M4 18h12V6h-4V2H4v16zm-2 1V0h12l4 4v16H2v-1z" />,
  ...
  factory: <path d="M10.5 20H0V7l5 3.33V7l5 3.33V7l5 3.33V0h5v20h-9.5z" />,
  "fast-forward": <path d="M1 5l9 5-9 5V5zm9 0l9 5-9 5V5z" />,
  "fast-rewind": <path d="M19 5v10l-9-5 9-5zm-9 0v10l-9-5 9-5z" />,
  film: (
  ...
  filter: <path d="M12 12l8-8V0H0v4l8 8v8l4-4v-4z" />,
  flag: <path d="M7.667 12H2v8H0V0h12l.333 2H20l-3 6 3 6H8l-.333-2z" />,
  flashlight: (
  ...
  "format-italic": <path d="M8 1h9v2H8V1zm3 2h3L8 17H5l6-14zM2 17h9v2H2v-2z" />,
  "format-text-size": (
    <path d="M16 9v8h-2V9h-4V7h10v2h-4zM8 5v12H6V5H0V3h15v2H8z" />
  ),
  "format-underline": (
  ...
  "forward-step": <path d="M13 5h3v10h-3V5zM4 5l9 5-9 5V5z" />,
  forward: <path d="M1 5l9 5-9 5V5zm9 0l9 5-9 5V5z" />,
  gift: (
  ...
  "location-current": <path d="M0 0l20 8-8 4-2 8z" />,
  "location-food": (
  ...
  map: <path d="M0 0l6 4 8-4 6 4v16l-6-4-8 4-6-4V0zm7 6v11l6-3V3L7 6z" />,
  ...
  pause: <path d="M5 4h3v12H5V4zm7 0h3v12h-3V4z" />,
  "pen-tool": (
  ...
  pin: <path d="M11 12h6v-1l-3-1V2l3-1V0H3v1l3 1v8l-3 1v1h6v7l1 1 1-1v-7z" />,
  "play-outline": (
  ...
  queue: <path d="M0 2h20v4H0V2zm0 8h20v2H0v-2zm0 6h20v2H0v-2z" />,
  "radar copy 2": (
  ...
  "step-backward": <path d="M4 5h3v10H4V5zm12 0v10l-9-5 9-5z" />,
  "step-forward": <path d="M13 5h3v10h-3V5zM4 5l9 5-9 5V5z" />,
  stethoscope: (
  ...
  "subdirectory-left": <path d="M18 12v1H8v5l-6-6 6-6v5h8V2h2z" />,
  "subdirectory-right": <path d="M3.5 13H12v5l6-6-6-6v5H4V2H2v11z" />,
  swap: (
  ...
  "volume-mute": <path d="M9 7H5v6h4l5 5V2L9 7z" />,
  "volume-off": (
